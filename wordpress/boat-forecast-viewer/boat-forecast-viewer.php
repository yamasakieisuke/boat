...
<?php echo boat_forecast_viewer_font_links(); ?>
    <style>
<?php boat_forecast_viewer_css('common', 'single'); ?>
    </style>
</head>
<body>
<?php
...
<?php echo boat_forecast_viewer_font_links(); ?>
    <style>
<?php boat_forecast_viewer_css('common', 'archive'); ?>
    </style>
</head>
<body>
<?php
...
<?php echo boat_forecast_viewer_font_links(); ?>
    <style>
<?php boat_forecast_viewer_css('common', 'review'); ?>
    </style>
</head>
<body>
...
<?php echo boat_forecast_viewer_font_links(); ?>
    <style>
<?php boat_forecast_viewer_css('common', 'accuracy'); ?>
    </style>
</head>
<body>
...
<?php echo boat_forecast_viewer_font_links(); ?>
    <style>
<?php boat_forecast_viewer_css('common', 'player'); ?>
    </style>
</head>
<body>
